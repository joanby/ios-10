...
class MessagesViewController: MSMessagesAppViewController {
    ...
    override func willBecomeActive(with conversation: MSConversation) {
        ...
        print("Nuestra app está a punto de mostrarse")
    }
    ...
    override func didCancelSending(_ message: MSMessage, conversation: MSConversation) {
        ...
        print("El usuario ha dejado de enviar el mensaje")
    }
    ...
    @IBAction func sendGreetingsPressed(_ sender: UIButton) {
        ...
        /*let path = Bundle.main().urlForResource("audio", withExtension: "mp3")
        ...
        layout.image = #imageLiteral(resourceName: "frogamesLogoFull4") //UIImage(named:"nombre de la imagen")
